...
- Admin dapat melampirkan dokumen tambahan (custom documents) saat menambahkan customer secara manual, di luar 3 dokumen standar.
...
|-------|-------------|-------|
| FR-CA-01 | Sistem harus menyediakan halaman registrasi bagi customer baru dengan field: Customer Name, NPWP, PIC Name, Phone Number, Email, Address, Note; Tipe Pelanggan di-default ke "Cargo Owner" oleh sistem | Customer |
